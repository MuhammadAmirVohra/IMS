        ...
        <Card className="Card1">
          ...
          <Card.Body ref={ref}>
            <Card.Title>
              ...
              {details.request.Order_ID}
            </Card.Title>
            <Card.Title>
              <strong>Name: </strong>
              {details.request.R_Emp_Name}
            </Card.Title>
            <Card.Title>
              <strong>Email: </strong>
              {details.request.R_Emp_Email}
            </Card.Title>
            <Card.Title>
            ...
            <Card.Title>
              ...
              {moment(details.request.Added).format("Do MMMM YYYY")}
            </Card.Title>
            <Card.Title>
              <strong>Accounts Manager Comments : </strong>
              {details.comment.Comment_Accounts}
            </Card.Title>
            <Card.Title>
              <strong>Admin Manager Comments : </strong>
              {details.comment.Comment_Admin}
            </Card.Title>
          ...
          <Card.Footer className="">
            ...
            <Button className="Btn float-right" onClick={PDF}>
              Generate PDF
            </Button>
          </Card.Footer>
        </Card>
