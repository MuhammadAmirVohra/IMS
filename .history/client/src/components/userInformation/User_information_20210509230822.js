...
const UserInformation = () => {
    ...
    <Card className="Card1">
        <Card.Header className="Card1">User Information</Card.Header>
            <Card.Body className="Card1">

                { Profile &&
                <>
                    <Card.Title className="Card1"><strong>User:  </strong>{Profile.emp_Name}</Card.Title>
                    <Card.Title className="Card1"><strong>Designation:</strong> {Profile.designation}</Card.Title>  
                    <Card.Title className="Card1"><strong>Department:</strong> {Profile.department}</Card.Title>  
                    <Button
                        className="Btn mb-4"
